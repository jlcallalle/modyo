(function($) {
    ...
    $("#sidebarToggle, #sidebarToggleTop").on('click', function(e) {
      ...
      $(".sidebar  > li.nav-item > a.nav-link").each(function(){
        if ( path === '/cd-qa-invex/historial' && $(this).attr("href") == 'https://invex.modyo.be/cd-qa-invex/historial' || 
             path === '/cd-qa-invex/inicio' && $(this).attr("href") == 'https://invex.modyo.be/cd-qa-invex/inicio') {
